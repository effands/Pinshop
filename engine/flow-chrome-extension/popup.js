...
chrome.storage.local.get(['instanceId', 'instanceName'], (data) => {
  const id = data.instanceId || 'belum dibuat';
  document.getElementById('instance-id').textContent = `${data.instanceName || 'Chrome'} · ${id.slice(0, 8)}`;
});
